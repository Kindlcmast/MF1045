function yt = derivataacceleration(t,y,DM)
...
% funktionsfilerna:
%   1. motormoment.m
%   2. kopplingsmoment.m (Måste revideras så att den motsvara konstruktion på koppling)
%   3. lastmoment.m
%
% Anders Söderberg, KTH Maskinkonstuktion, 2023-08-21
...
if omega1>omega2 || (omega1== 0 && omega2==0)       % Slirar
    ...
    omega2t = omega1t;
    F = (MM-ML/(eta*u))/(JM+JK1+JK2+JV1+(JV2+JL)/(eta*u^2));
end
omega3t = omega2t/u;
vt      = omega3t*r;
st      = v;
